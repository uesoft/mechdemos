% This M-file generates the initial geometric, dynamic, and controller
% information for the Stewart platform in controls case study.  The Stewart
% platform consists of a top plate, a bottom plate, and six legs connecting
% the top plate to the bottom plate.  The overall system has six independent
% degrees of freedom.  Each disconnected leg has six degrees of freedom and
% is composed of two bodies and one cylindrical and two universal joints.
% 
...
% Upper and lower leg inertia and mass
...
% Reference motion, dynamical, and control constants
freq = pi; A = 100*freq; noise_freq = 200*freq/2/pi;
force_act_max = 3e5;

Ki = 1e4; Kp = 2e6; Kd = 4.5e4;

initCondI = (upper_leg_mass+lower_leg_mass+(top_mass*1.3/6))*9.81/Ki;