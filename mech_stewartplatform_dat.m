% Geometry and dynamics information for Stewart platform in the home
% configuration. A Stewart platform consists of a top plate, a bottom plate,
% and six legs connecting the top plate to the bottom plate. The overall
% system has six degrees of freedom. Each leg is composed of two bodies,
% two universal joints, and one cylindrical joint and, if disconnected, has
% six degrees of freedom. The constraints imposed by connecting the legs to
% the plates eliminate all but one independent degree of freeedom for each
% leg.
